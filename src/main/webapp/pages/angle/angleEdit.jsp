...
<div align="center" style="margin-top: 30px;">
	<form id="angle_form" method="post" draggable="true" enctype="multipart/form-data">
		<input name="id" id="id" type="hidden"/>
		<table class="tableForm" id="tableForm">
			<tr>
				<th >名称：</th>
				<td><input id="name" name="name" class="easyui-validatebox" style="width: 300px;" data-options="required:'true'" /></td>
			</tr>
			<!-- 缩略图 -->
			<tr>
				 <th >logo图：</th>
				 <td>
					<input id="angleImage" class="easyui-validatebox" data-options="" name="angleImage" type="file" onchange="setImagePreview('angleImage','previewImage')" style="height: 27px" accept="image/gif, image/jpeg, image/png"/>
				 </td>
			</tr>
			<tr height="15px">
					<td></td>
